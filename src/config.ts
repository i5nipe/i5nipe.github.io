...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "/Cover_dither.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/iSnipe.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "i5nipe",
